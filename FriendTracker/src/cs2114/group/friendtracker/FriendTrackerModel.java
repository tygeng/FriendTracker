...
public class FriendTrackerModel
{
     ...
     *
     * @param contacts  The set of contacts for the model
     * @param self      The user's information
     */
     ...
     *
     * @param addition  The person to add to the list of contacts
     */
     ...
     *
     * @param self  The new user information
     */
